...
/**
 * Custom pages sidebar component
 *
 * @module      local_custompage/sidebar
...
const sidebarCardFilter = (event, sidebarMenu) => {
    const pendingPromise = new Pending('local_custompage/sidebar:cardFilter');
...
export const init = (selectorId) => {
    ...
    sidebarSearch.addEventListener('keyup', event => {
        const pendingPromise = new Pending('local_custompage/sidebar:keyup');
