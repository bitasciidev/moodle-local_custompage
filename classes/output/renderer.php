...
/**
 * Renderer for local_custompage plugin.
 *
...
/**
 * Renderer class for local_custompage plugin.
 *
 * @package    local_custompage
 * @copyright  2024 BitAscii Solutions <bitascii.dev@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class renderer extends plugin_renderer_base {
    ...
    public function render_fullpage_editor_header(page $page): string {
        ...
        $editdetailsbutton = html_writer::tag('button', get_string('editpagedetails', 'local_custompage'), [
