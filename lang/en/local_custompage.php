...
$string['categoryrole'] = 'Category role assignments';
$string['categoryrole_help'] = 'Users with specific roles assigned in selected course categories';
$string['cohorts'] = 'Cohorts';
$string['cohorts_help'] = 'Users who are members of selected cohorts';
$string['categories'] = 'Categories';
$string['categories_help'] = 'Users enrolled in courses within selected categories';
$string['categoryrole_categories_help'] = 'Select specific categories or leave empty to include all categories';
$string['categoryrole_roles_help'] = 'Select specific roles or leave empty to include all roles';
