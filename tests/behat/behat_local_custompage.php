...
/**
 * Behat data generator for local_custompage.
 *
 ...
 * Behat data generator for local_custompage.
 */
class behat_local_custompage_generator extends behat_generator_base {
    /**
    ...
    protected function get_page_id(string $name): int {
        ...
        if (!$id = $DB->get_field('local_custompages', 'id', ['name' => $name])) {
