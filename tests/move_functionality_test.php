...
use local_custompage\external\page\update_sort_order;
use local_custompage\constants;
use local_custompage\local\custompage\page as page_helper;
...
final class move_functionality_test extends \advanced_testcase {
    ...
    public function test_sortthread_persistence(): void {
        ...
        $dbpage1 = $DB->get_record('local_custompages', ['id' => $page1->get('id')]);
        $dbpage2 = $DB->get_record('local_custompages', ['id' => $page2->get('id')]);

        $this->assertEquals('02', $dbpage1->sortthread);
        $this->assertEquals('01', $dbpage2->sortthread);

        // Verify ordering query works correctly.
        $pages = $DB->get_records('local_custompages', null, 'sortthread ASC');
    ...
    public function test_move_child_to_root_and_back(): void {
        ...
        $allpages = $DB->get_records('local_custompages', null, 'sortthread ASC');
     ...
     *
     * This specifically validates local_custompage_page_update_sort_order:
