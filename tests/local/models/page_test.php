 ...
 * @covers     \local_custompage\local\models\page
...
final class page_test extends advanced_testcase {
    ...
    public function test_get_url(): void {
        ...
        $url = $page->get_url();
        $expectedurl = new \moodle_url('/local/custompage/view.php', ['id' => $page->get('id')]);
    ...
    public function test_page_created_event(): void {
        ...
        $this->assertInstanceOf(custompage_created::class, $events[0]);
    }
    ...
    public function test_page_updated_event(): void {
        ...
        $this->assertCount(1, $events);
        $this->assertInstanceOf(custompage_updated::class, $events[0]);
    }
    ...
    public function test_page_deleted_event(): void {
        ...
        $this->assertCount(1, $events);
        $this->assertInstanceOf(custompage_deleted::class, $events[0]);
    }
