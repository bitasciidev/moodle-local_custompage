 ...
 * @covers     \local_custompage\permission
...
final class permission_test extends advanced_testcase {
     ...
     * Note: User needs local/custompage:view capability to view pages list.
     */
    public function test_permissions_with_userid(): void {
        ...
        assign_capability('local/custompage:view', CAP_ALLOW, $roleid, $context->id);
