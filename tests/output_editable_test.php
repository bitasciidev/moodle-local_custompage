 ...
 * @covers     \local_custompage\output\page_name_editable
 * @covers     \local_custompage\output\page_title_editable
...
final class output_editable_test extends advanced_testcase {
    ...
    public function test_page_name_editable_is_enabled_for_editor(): void {
        ...
        $PAGE->set_url('/local/custompage/index.php');
        ...
        $this->assertSame('local_custompage', $exported['component']);
